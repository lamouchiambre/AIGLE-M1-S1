...
// Job A
class Map12_1A extends Mapper<LongWritable, Text, Text, IntWritable> {
...
class Reduce12_1A extends Reducer<Text, IntWritable, Text, Text> {
...
// Job B
class Map12_1B extends Mapper<LongWritable, Text, Text, IntWritable> {
	private final static String emptyWords[] = { "" };
	private static int compt = 0;
...
class Reduce12_1B extends Reducer<Text, IntWritable, Text, IntWritable> {
	private static final Logger LOG = Logger.getLogger(Exo12_1_TAM.class.getName());
	/**
...
public class Exo12_1_TAM {
	private static final String INPUT_PATH_A = "input-tam/";
	private static final String OUTPUT_PATH_A = "output/exo12-1A-";
	private static final String OUTPUT_PATH_B = "output/exo12-1B-";
	...
	public static void main(String[] args) throws Exception {
		...
		jobA.setMapperClass(Map12_1A.class);
		jobA.setReducerClass(Reduce12_1A.class);
		...
		jobB.setMapperClass(Map12_1B.class);
		jobB.setReducerClass(Reduce12_1B.class);
